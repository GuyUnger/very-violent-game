...
func hit(damage: int) -> void:
	...
	if has_node("Armature/Skeleton3D/Skin"):
		...
		$Armature/Skeleton3D/Skin.set_instance_shader_parameter("color", Color.RED)
		hit_tween_.tween_interval(0.2)
		hit_tween_.tween_property($Armature/Skeleton3D/Skin, "instance_shader_parameters/color", Color(1.0, 1.0, 1.0, 0.0), 0.0)
